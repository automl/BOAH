...
then
   python run_experiment.py --exp_name pendulum --run_id 43 --nic_name eth0 --no_worker --opt_method bohb --dest_dir opt_results/pendulum/bohb --min_budget 1 --n_workers 4
else
   python run_experiment.py --exp_name pendulum --run_id 43 --nic_name eth0 --worker --opt_method bohb --dest_dir opt_results/pendulum/bohb --min_budget 1 --n_workers 4
fi
