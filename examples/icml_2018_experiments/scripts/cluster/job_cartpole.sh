...
if [ $SLURM_ARRAY_TASK_ID -eq 1 ]
   then python run_experiment.py --exp_name cartpole --run_id 43 --nic_name eth0 --opt_method bohb --max_budget 9 --min_budget 1
else
   python run_experiment.py --exp_name cartpole --run_id 43 --nic_name eth0 --worker --opt_method bohb --max_budget 9 --min_budget 1
fi
